/obj/item/clothing/suit/roguetown/armor/cuirass/iron/gnome
	...
	icon_state = "gnome_armor"
	item_state = "gnome_armor_item"
...
/obj/item/clothing/suit/roguetown/shirt/robe/gnome
	...
	icon = 'icons/roguetown/mob/monster/gnome.dmi'
	icon_state = "gnome_robe"
	item_state = "gnome_robe_item"
	allowed_race = list("gnome")
...
/obj/item/clothing/suit/roguetown/shirt/robe/gnome/bog
	...
	icon_state = "gnome_robe_bog"
	item_state = "gnome_robe_bog_item"
...
/obj/item/clothing/head/roguetown/helmet/leather/fungi
	...
	icon = 'icons/roguetown/mob/monster/gnome.dmi'
	icon_state = "fungi_helm"
	item_state = "fungi_helm_item"
	allowed_race = list("gnome")

/obj/item/clothing/head/roguetown/helmet/leather/fungi/bog
	icon_state = "fungi_bog_helm"
	item_state = "fungi_helm_bog_item"
...
/obj/item/clothing/head/roguetown/helmet/leather/gnomehat
	...
	icon = 'icons/roguetown/mob/monster/gnome.dmi'
	icon_state = "gnome_helm"
	item_state = "gnome_helm_item"
	allowed_race = list("gnome")
...
/obj/item/clothing/head/roguetown/helmet/gnomespike
	...
	icon = 'icons/roguetown/mob/monster/gnome.dmi'
	icon_state = "spike_helm"
	item_state = "spike_helm_item"
	allowed_race = list("gnome")
